...
export default function Aboutus() {
  return (
    <section className="py-16 bg-gray-100">
      <motion.h2
          className="text-2xl md:text-4xl font-normal text-center text-blue-700"
...
*/}
          ...
          <div className="flex gap-3 mt-10">
                      <Link
                        href="/visit"
                        className="bg-red-700 text-white w-full text-center py-3 rounded-2xl font-medium hover:bg-blue-700 transition"
                      >
                        learn more...
                      </Link>
                      <Link
                        href="/live"
                        className="bg-red-600 text-white w-full text-center py-3 rounded-2xl font-medium hover:bg-blue-600 transition"
                      >
                        Join us
                      </Link>
                    </div>
