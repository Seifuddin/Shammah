...
export default function Ready() {
  return (
    <div className='relative p-5 bg-yellow-600'>
        <div className='relative'>
            {/* Call to Action */}
                    <motion.div
                      ...
                      className="bg-yellow-600 text-white py-12 px-6 rounded-2xl text-center"
                    >
            ...
            Ready to accept Jesus today?
                      ...
                      <a
                        href="contacts"
                        className="mt-6 inline-block bg-white text-yellow-600 font-semibold px-6 py-3 rounded-full hover:bg-gray-100 transition"
                      >
                        Talk to Us
                      </a>
                    </motion.div>
